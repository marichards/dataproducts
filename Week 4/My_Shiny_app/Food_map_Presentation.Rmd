...
For a more in-depth look at the back end, let's take a quick look at what the server does in my app. 
...
We'll calculate the distance from the default location( lng = -122.3 and lat = 47.6) to Pike Place Market
